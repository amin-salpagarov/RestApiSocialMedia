...
class PostTestCase(APITestCase):
    ...
    def test_try_to_put_other_post(self):
        post = PostFactory(
            author=self.user,
            title="old_title",
            body="old_body",
        ...
        self.assertFalse(response.data["title"] == new_data["title"])
        self.assertFalse(response.data["body"] == new_data["body"])

        post.refresh_from_db()
        self.assertFalse(post.title == new_data["title"])
        self.assertFalse(post.body == new_data["body"])
